...
class CTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    headlineLarge: const TextStyle()
        .copyWith(fontSize: 32.0, fontWeight: FontWeight.bold, color: CColors.dark, fontFamily: "coolvetica"),
    headlineMedium: const TextStyle()
        .copyWith(fontSize: 24.0, fontWeight: FontWeight.w600, color: CColors.dark, fontFamily: "coolvetica"),
    ...
    bodySmall:
        const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w500, color: CColors.dark.withOpacity(0.5)),
    labelLarge: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: CColors.dark),
    labelMedium:
        const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: CColors.dark.withOpacity(0.5)),
  );
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    bodySmall:
        const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w500, color: CColors.light.withOpacity(0.5)),
    labelLarge: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: CColors.light),
    labelMedium: const TextStyle()
        .copyWith(fontSize: 12.0, fontWeight: FontWeight.normal, color: CColors.light.withOpacity(0.5)),
  );
}
